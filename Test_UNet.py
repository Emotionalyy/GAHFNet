...
def inference():
    ...
    parser.add_argument('--backbone', type=str, default='UNet_400',
    ...
    parser.add_argument('--pth_path', type=str, default='./Snapshots/save_weights/Semi-UNet_400/UNet_400-100.pth',
                        help='Path to weights file if `semi-sup`, edit it to `Semi-Inf-Net/Semi-Inf-Net-100.pth`')
    parser.add_argument('--save_path', type=str, default='./Results/Semi-UNet_400/',
