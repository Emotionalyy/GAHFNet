...
def train(train_loader, model, optimizer, epoch, train_save):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            # ---- forward ----
            lateral_map_5, lateral_map_4, lateral_map_3, lateral_map_2, lateral_map_1, highmap, lateral_edge, a = model(
                images)  #
            # ---- loss function ----
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default=r'./Dataset/TrainingSet/Pseudo-label')
    ...
    if opt.is_semi and opt.backbone == 'mynet_VGG':
        ...
        model.load_state_dict(torch.load('./Snapshots/save_weights/mynet_VGG_Pseudo/mynet_VGG-100.pth'),
                              strict=False)
    else:
